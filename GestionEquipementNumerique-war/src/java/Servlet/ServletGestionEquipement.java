    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            */
                ...
                Membre membre=sessionMembre.RechercherMembre(membreId);
                ...
                if (prenom.trim().isEmpty() || nom.trim().isEmpty() || login.trim().isEmpty() || mdp.trim().isEmpty() || tel.trim().isEmpty() || agence == null || bureau.trim().isEmpty()){
                    ...
                    if (mdp.length() < 8) {
                        ...
                        if (recherche==true){
                            ...
                            //Superviseur s=sessionAdministrateur.InscriptionUtilisateur(login, encryptedMdp, nom, prenom, bureau, tel, agence);
